...
class ChatMemberUpdated extends Type
{
     ...
     * @param  bool  $via_join_request  <em>Optional</em>. True, if the user joined the chat after sending a direct join request without using an invite link and being approved by an administrator
