...
class ChatMemberUpdated extends Type
{
    ...
    /** <em>Optional</em>. <em>True</em>, if the user joined the chat after sending a direct join request without using an invite link and being approved by an administrator */
    public ?bool $via_join_request = null;

    /** <em>Optional</em>. <em>True</em>, if the user joined the chat via a chat folder invite link */
     ...
     * @param  bool  $via_join_request  <em>Optional</em>. <em>True</em>, if the user joined the chat after sending a direct join request without using an invite link and being approved by an administrator
     * @param  bool  $via_chat_folder_invite_link  <em>Optional</em>. <em>True</em>, if the user joined the chat via a chat folder invite link
     */
