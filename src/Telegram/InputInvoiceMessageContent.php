...
class InputInvoiceMessageContent extends InputMessageContent
{
     ...
     * @param  bool  $need_name <em>Optional</em>. Pass <em>True</em> if you require the user's full name to complete the order
     * @param  bool  $need_phone_number <em>Optional</em>. Pass <em>True</em> if you require the user's phone number to complete the order
     * @param  bool  $need_email <em>Optional</em>. Pass <em>True</em> if you require the user's email address to complete the order
     * @param  bool  $need_shipping_address <em>Optional</em>. Pass <em>True</em> if you require the user's shipping address to complete the order
     * @param  bool  $send_phone_number_to_provider <em>Optional</em>. Pass <em>True</em> if the user's phone number should be sent to provider
     * @param  bool  $send_email_to_provider <em>Optional</em>. Pass <em>True</em> if the user's email address should be sent to provider
     * @param  bool  $is_flexible <em>Optional</em>. Pass <em>True</em> if the final price depends on the shipping method
     */
