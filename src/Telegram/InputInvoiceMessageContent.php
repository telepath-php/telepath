...
class InputInvoiceMessageContent extends InputMessageContent
{
     ...
     * @param string $photo_url Optional. URL of the product photo for the invoice. Can be a photo of the goods or a marketing image for a service. People like it better when they see what they are paying for.
     * @param int $photo_size Optional. Photo size
     ...
     * @param bool $send_phone_number_to_provider Optional. Pass True, if user's phone number should be sent to provider
