...
class ChatBoostSourceGiveaway extends ChatBoostSource
{
    ...
    /** <em>Optional</em>. <em>True</em>, if the giveaway was completed, but there was no user to win the prize */
     ...
     * @param  bool  $is_unclaimed  <em>Optional</em>. <em>True</em>, if the giveaway was completed, but there was no user to win the prize
     */
